          ...
          >
            <div className="relative p-8 rounded-2xl bg-[#0a0a0a]/95 backdrop-blur-sm animate-float gold-border-glow">
              ...
              <div className="grid grid-cols-4 gap-2 mb-6">
                <div className="text-center px-1 py-3 rounded-lg bg-gradient-to-b from-[#C9A86C]/20 to-transparent border border-white/20">
                  <p className="text-sm font-bold gold-gradient-text whitespace-nowrap">250€</p>
                  <p className="text-[10px] text-white/60 mt-1">Stufe 1*</p>
                </div>
                <div className="text-center px-1 py-3 rounded-lg bg-gradient-to-b from-[#C9A86C]/25 to-transparent border border-white/20">
                  <p className="text-sm font-bold gold-gradient-text whitespace-nowrap">500€</p>
                  <p className="text-[10px] text-white/60 mt-1">Stufe 2*</p>
                </div>
                <div className="text-center px-1 py-3 rounded-lg bg-gradient-to-b from-[#C9A86C]/30 to-transparent border border-white/20">
                  <p className="text-sm font-bold gold-gradient-text whitespace-nowrap">1.000€</p>
                  <p className="text-[10px] text-white/60 mt-1">Stufe 3*</p>
                </div>
                <div className="text-center px-1 py-3 rounded-lg bg-gradient-to-b from-[#C9A86C]/40 to-transparent border border-white/20">
                  <p className="text-sm font-bold gold-gradient-text whitespace-nowrap">1.250€</p>
              ...
              <div className="mb-5">
                <div className="grid grid-cols-4 gap-1 mb-4">
                  ...
                  <div className="text-center px-2 py-3 rounded-lg bg-black/80 gold-border-glow">
                    ...
                    <p className="text-[8px] text-white/50">Junior Manager</p>
                  </div>
                  {/* Stufe 2 */}
                  <div className="text-center px-2 py-3 rounded-lg bg-black/80 gold-border-glow">
                  ...
                  <div className="text-center px-2 py-3 rounded-lg bg-black/80 gold-border-glow">
                    ...
                    <p className="text-[8px] text-white/50">Jr. Teamleiter</p>
                  </div>
                  {/* Stufe 4 */}
                  <div className="text-center px-2 py-3 rounded-lg bg-black/80 gold-border-glow">
