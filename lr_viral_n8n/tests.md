...
- Minimal: Run a single ideation + 1 image + 1 short video with watermark to hosting; approvals mocked.
- Full: All lanes active (Animal + Hologram), 3–5 images, 1 avatar, 1 animal video, watermark, approvals, distribution.
...
- Audio -20 LUFS, binaural, sync < 80 ms.
